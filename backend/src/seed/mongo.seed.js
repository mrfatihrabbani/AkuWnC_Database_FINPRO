...
const movies = [
  ...
  { title: 'Paterno', year: 2018, director: 'Barry Levinson', genres: ['Drama', 'History', 'TV Movie'], synopsis: 'Joe Paterno is embroiled in Penn State\'s sexual-abuse scandal.', runtime: 105, language: 'English' },
  ...
  { title: 'The Tale', year: 2018, director: 'Jennifer Fox', genres: ['Drama', 'Mystery', 'TV Movie'], synopsis: 'A woman is forced to re-examine her first sexual relationship.', runtime: 114, language: 'English' },
